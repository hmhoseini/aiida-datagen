...
from aiida_datagen.codes.flame.flame_functions.io_yaml import read_yaml, atoms2dict
from aiida_datagen.codes.flame.flame_functions.ascii import ascii_read
from aiida_datagen.codes.flame.flame_functions.io_bin import bin_read

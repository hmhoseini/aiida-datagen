...
def write_extra_files(job_type_info, folder):
    ...
    if 'gensymcrys' in job_type_info.keys():
        ...
        from aiida_datagen.codes.flame.minimahopping import write_minhopp_files
        ...
        from aiida_datagen.codes.flame.divcheck import write_divcheck_files
        ...
        from aiida_datagen.codes.flame.qbc import write_SP_files

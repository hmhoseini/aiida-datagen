...
from aiida_datagen.codes.flame.flame_launch_calculations import (
...
from aiida_datagen.codes.utils import get_time, get_pertured_failed_structures, get_rejected_structures, store_calculation_nodes 
from aiida_datagen.codes.flame.averdist import store_averdist_results
from aiida_datagen.codes.flame.train import pre_train, select_a_train
from aiida_datagen.codes.flame.minimahopping import (
    get_seeds,
    store_minhocao_results,
    store_minhopp_results)
from aiida_datagen.codes.flame.qbc import store_ref_sigma, store_to_be_labeled_structures, get_to_be_labeled_structures, get_qbc_data
from aiida_datagen.codes.flame.divcheck import (
    get_bulk_nats,
    get_cluster_nats,
...
######Single point calculations######
        if cycle_name == 'SP':
            ...
            if 'VASP' in settings.inputs['ab_initio_code']:
                from aiida_datagen.codes.vasp.vasp_launch_calculations import VASPSPSubmissionController
                ...
                from aiida_datagen.codes.cp2k.cp2k_launch_calculations import CP2KSPSubmissionController
                log_write(f'Ab-initio calculations with {settings.inputs["ab_initio_code"]}'+'\n')

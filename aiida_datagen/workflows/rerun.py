...
from aiida_datagen.workflows.core import log_write, report
from aiida_datagen.workflows.settings import groups
from aiida_datagen.codes.flame.minimahopping import store_minhocao_results, store_minhopp_results
...
def rerun():
    ...
    if 'step3' in active_group.label:
        ...
        from aiida_datagen.codes.flame.flame_launch_calculations import MinimaHoppingSubmissionController
